...
pinMode(Sattelkammer, INPUT_PULLUP);
  ...
  Serial.println("Spinnde:,Sattelkammer:,Gruene:,Minimal:");
...
while (Schleife < 10000 && minimal > 980 && EEPROM.read(2) == 0 && value == 1) {
  Schleife++;
  Serial.println("");
Gruene_Werte = analogRead(A12);

Sattelkammer_Werte = analogRead(A13);

Spinde_Werte = analogRead(A14);
/*Serial.print("Spinde: ");
Serial.print(Spinde_Werte);Serial.print(",");
Serial.print("Sattelkammer: ");
Serial.print(Sattelkammer_Werte);Serial.print(",");
Serial.print("Gruene: ");
Serial.print(Gruene_Werte); Serial.print(",");
*/
//if (Spinde_Werte == 0) {
  //Spinde_Werte = 1023;
//}
if (Sattelkammer_Werte == 0) {
  Sattelkammer_Werte = 1023;
}
if (Gruene_Werte == 0) {
  Gruene_Werte = 1023;
}
// Gruene_Werte = 1023;
if (Spinde_Werte <= minimal) {
 minimal = Spinde_Werte;
}
if (Sattelkammer_Werte <= minimal) {
 minimal = Sattelkammer_Werte;
}
if (Gruene_Werte <= minimal) {
 minimal = Gruene_Werte;
}
//Serial.println(Gruene_Werte);
//Serial.println(Sattelkammer_Werte);
//Serial.print("Min: ");
...
Serial.print(minimal);
if(Gruene_Werte <= 980){
  //Serial.print(",");Serial.print(",");Serial.print("Achtung Gruen");Serial.println("");
  Gruen = true;
}
else {
Gruen = false;
}
if(Sattelkammer_Werte <= 980){
//  Serial.print(",");Serial.print("Achtung Sattelkammer");Serial.println("");
  Sattelkammer = true;
}
else {
Sattelkammer = false;
...
if(Spinde_Werte <= 980){
  //Serial.print("Achtung Spind");Serial.println("");

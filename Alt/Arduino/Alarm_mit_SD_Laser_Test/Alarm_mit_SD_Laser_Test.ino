...
laut();
  ...
  if (dataFile) {
    dataFile.println("Entfangen: ");
    dataFile.print(mySwitch.getReceivedValue());
    dataFile.close();
    // print to the serial port too:
